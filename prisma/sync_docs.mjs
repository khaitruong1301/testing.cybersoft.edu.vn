...
// ── Công nghệ mới cho Tester (SKILL_CONG_NGHE_MOI_TESTER) ──
import { CNM_AI_TESTCASE_01 } from "./doc_cnm_ai_testcase.mjs";
import { CNM_LLM_TESTING_01 } from "./doc_cnm_llm_testing.mjs";
