...
// =============== makeThumb v2 — mỗi bài id khác nhau => icon & cảnh khác nhau ===============
export function makeThumb({ id = "t", domain = "default", kind = "congnghe", label = "", tech = null, motifKey = null }) {
  ...
  const heroType = motifKey || classifyMotif(label, kind);
